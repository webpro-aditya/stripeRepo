        ...
        <div class="flex shadow-md my-10">
            ...
            <div id="summary" class="w-1/4 px-8 py-10">
                ...
                <div class="border-t mt-8">
                    ...
                    <a href="{{ route('stripe.checkout') }}" class="block text-center bg-indigo-500 font-semibold hover:bg-indigo-600 py-3 text-sm text-white uppercase w-full">Checkout</a>
                </div>
            </div>
